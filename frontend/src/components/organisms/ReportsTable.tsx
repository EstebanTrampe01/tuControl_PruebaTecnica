      ...
      <Table className="[&_tbody_tr]:border-b-slate-100 [&_tbody_tr:hover]:bg-primary-50/60 dark:[&_tbody_tr]:border-zinc-800 dark:[&_tbody_tr:hover]:bg-zinc-800/60 [&_tr:last-child]:border-0">
        <TableHeader>
          <TableRow className="operational-table-head-row">
            ...
            <TableHead className="operational-table-head-cell sticky top-0 z-10">Producto</TableHead>
            <TableHead className="operational-table-head-cell sticky top-0 z-10 text-right">Cant. vendida</TableHead>
            <TableHead className="operational-table-head-cell sticky top-0 z-10 text-right">Total vendido</TableHead>
          </TableRow>
        </TableHeader>
